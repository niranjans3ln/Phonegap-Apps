...
window.Typekit.config = {
	"f" : "//use.edgefonts.net/c/e39327/source-sans-pro:n4:n7:i4:i7.Xd2:F:2,Xcv:F:2,Xcz:F:2,Xcw:F:2/{format}{/extras*}",
	"fn" : ["source-sans-pro", ["n4", "n7", "i4", "i7"]],
	"p" : "//p.typekit.net/p.gif?s=4&h={host}&f=17265.17267.17269.17268&app={app}&_={_}"
};
...
(function (window, document, undefined) {
	...
	U.prototype.m = function (a, c) {
		var b = c || {},
		e = this.Xa.replace(/\{\/?([^*}]*)(\*?)\}/g, function (a, c, e) {
	...
	Oa.prototype.m = function (a, c) {
		...
		if ("MSIE" == a.getName()) {
			...
			var f = this,
			h = function () {
				var a = Pa(f, "scrollLeft", "scrollTop"),
